...
var BASE_PACKAGE = {
  description: 'A full DYN node build with Bitcore',
  repository: 'https://github.com/wkibbler/bitcore-node-ABC',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-DYN': 'wkibbler/bitcore-lib-ABC',
    'bitcore-node-DYN': 'wkibbler/bitcore-node-ABC'
  }
};
